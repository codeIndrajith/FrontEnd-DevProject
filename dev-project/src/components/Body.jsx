...
function Body() {
  return (
    <div className="flex flex-col lg:mt-0 sm:mt-auto md:mt-auto mt-[80%] lg:p-10 p-10 space-y-14 justify-center items-center">
      ...
      <div className="md:w-[1064px] md:h-[414px] sm:w-[335px] sm:h-[572.82px] flex flex-col lg:justify-center items-center sm:justify-center sm:flex-col md:flex-row lg:flex-row lg:items-start">
